...
// Two-phase init:
//
// Phase 1 (DOMContentLoaded) — build all UI immediately so tabs/switcher appear.
// Phase 2 (setTimeout 0)     — patch TestEngine prototype AFTER script.js's own
//   DOMContentLoaded handler has run and instantiated testEngine. The class
//   declaration itself is hoisted, but setTimeout ensures our code always fires
//   after every other DOMContentLoaded handler registered before ours.
//
